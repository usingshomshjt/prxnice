...
const targetPort = parsedTarget.protocol === 'https:' ? 443 : 80;
    ...
    console.clear();
console.log('Script By : @nminh23'.bgRed.white);
console.log(`Target : ${parsedTarget.host}`.bgRed.white);
console.log(`Time : ${args.time.toString()} Second`.bgRed.white);
console.log(`Thread(s) : ${args.threads.toString()}`.bgRed.white);
console.log(`Rate : ${args.Rate.toString()}`.bgRed.white);
